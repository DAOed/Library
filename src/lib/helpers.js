...
export { getFile as rawGetFile } from "blockstack"
...
export const mdRenderer = new DefaultRenderer({
  ...
  usertagUrlFn: (account) => "/author?id=" + account,
  hashtagUrlFn: (hashtag) => "/tag?id=" + hashtag,
  isLinkSafeFn: () => true
})
